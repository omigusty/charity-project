<script>
  ...
  function calculateDay(date_end) {
...
<style>
  ...
  .number-percentage-count1 {
    margin-left: 30px;
  }

  .number-percentage-count2 {
    margin-left: 0;
  }
            ...
            <div class="xs-item-header">
              ...
              <div class="xs-skill-bar">
                <div class="xs-skill-track">
                  <p>
                    <span
                      class="number-percentage-count2 number-percentage"
                      data-value="90"
              ...
              <ul class="xs-list-with-content">
                ...
                <li>
                  <span
                    ...
                    data-value="90"
                    data-animation-duration="3500">{CalculateFunded(charity.pledged, charity.target)}</span>%
                  <span class="number-percentage-count1">Funded</span>
                </li>
                <li>{calculateDay(charity.date_end)}<span>Days to go</span></li>
              </ul>
...
<!-- stateless component adalah komponen yang tugasnya hanya menampilkan data dari induknya(app.svelte),
Sedangkan statefull component adalah komponen yang ada logicnya atau perhitungan data -->
